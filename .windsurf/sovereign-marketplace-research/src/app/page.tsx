...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ background: "var(--ink)" }}>
      ...
      {/* Above-the-fold Live Demo (safe duplicate wrapper; demo component unchanged) */}
      <section className="border-b rule-line" style={{ background: "var(--ink-2)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-6 pb-6">
          <div className="flex items-end justify-between gap-4 mb-4">
            <div>
              <div className="eyebrow mb-2">- Live Simulation</div>
              <h2 className="font-serif text-2xl sm:text-3xl tracking-tight" style={{ color: "var(--bone)" }}>
                See it work now.
              </h2>
            </div>
            <SovereignBadge size={56} />
          </div>
          <InteractiveDemo />
        </div>
      </section>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-20 sm:pt-32 sm:pb-28">
          <div className="max-w-4xl">
            <div className="eyebrow mb-6">â€” Sovereign Infrastructure / Token-Metered</div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-12">
            <div>
              ...
              <p className="text-base mt-4 max-w-xl leading-relaxed" style={{ color: "var(--bone-2)" }}>
                Pick a scenario â€” hospital, bank, or agency. Watch Veklom detect PII, auto-redact, meter tokens, enforce spend controls, and generate a crypto-signed audit trail.
              </p>
            </div>
      ...
      <section className="py-24" style={{ background: "var(--ink-2)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-16 max-w-2xl">
            <div className="eyebrow mb-4">â€” Why Veklom</div>
            <h2 className="font-serif text-4xl sm:text-5xl tracking-tight" style={{ color: "var(--bone)" }}>
      ...
      <section className="py-24 border-t rule-line" style={{ background: "var(--ink)" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-16 max-w-2xl">
            <div className="eyebrow mb-4">â€” Pricing</div>
            <h2 className="font-serif text-4xl sm:text-5xl tracking-tight" style={{ color: "var(--bone)" }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              { name: "Free", price: "$0", desc: "Explore â€” no card required", credits: "50K", features: ["1 API key", "Health endpoints", "Token wallet", "Community docs"], free: true },
              ...
              { name: "Enterprise", price: "Custom", desc: "Banks Â· Hospitals Â· Gov", credits: "Custom", features: ["Unlimited keys", "Dedicated AI agent", "Custom training", "99.99% SLA"] },
            ].map((plan) => (
              <div key={plan.name} className={plan.popular ? "card-brass p-8" : "card-ink p-8"}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  {plan.popular && <span className="eyebrow !text-[10px]" style={{ color: "var(--brass-2)" }}>â€” Popular</span>}
                </div>
      ...
      <section className="py-24 border-t rule-line" style={{ background: "var(--ink-2)" }}>
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="eyebrow mb-6">â€” Ready</div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            <div className="flex items-center gap-2.5">
              <Shield className="h-5 w-5" style={{ color: "var(--brass)" }} />
              <span className="font-serif text-lg" style={{ color: "var(--bone)" }}>Veklom</span>
              <span className="font-mono text-xs ml-3" style={{ color: "var(--mute)" }}>v1.0 Â· 2026</span>
            </div>
